...
function animatePlane() {
  let jet = document.getElementById('flyjet');
  jet.onclick = function () {
    let ended = false;

    flyjet.addEventListener('transitioned', function () {
      if (!ended) {
        ended = true;
        console.log('Done!');
      }
...
function bouncingBall() {
  ...
  let ball = document.getElementById('bounceBall');
  ball.onclick = function () {    
    let field = document.getElementById('bounceField');
